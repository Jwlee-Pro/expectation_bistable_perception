function plot_patch_transparent(x, data, data_std, colorX, transparency)
...
%     patch('Faces',face,'Vertices',vertex','Facecolor',[0.82 0.82 0.82],'line','none');
    patch('Faces',face,'Vertices',vertex','Facecolor', colorX, 'Facealpha', transparency, 'edgecolor','none');
