classdef Violin < handle
    ...
    methods
        function obj = Violin(data, pos, varargin)
            ...
            if numel(data) == 1
                obj.MedianPlot = scatter(pos, data,'filled','SizeData',10,'LineWidth',0.1);
            ...
            obj.ScatterPlot = ...
                scatter(pos + jitter.*jitterstrength, data, 'filled','SizeData',5,'LineWidth',0.1);
            ...
            obj.BoxPlot = ... % plot color will be overwritten later
                fill([pos-0.04 pos+0.04 pos+0.04 pos-0.04], ...
            ...
            obj.MedianPlot = scatter(pos, quartiles(2), [], [1 1 1], 'filled','SizeData',36);
