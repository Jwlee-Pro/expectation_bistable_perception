...
function eResult = eventLockedTS_FFFF(TS, TS_time, event_time, event_type, sf, event_time_all, Windowlength)
...
switch event_type
    case 'start' % transition start 
        eResult.WindowInd = (1:eResult.WindowLength_TS)-round(eResult.WindowLength_TS/3); 
    case 'mid'   % transition mid
        eResult.WindowInd = (1:eResult.WindowLength_TS)-round(2*eResult.WindowLength_TS/5);
